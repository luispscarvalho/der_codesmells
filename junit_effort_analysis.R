#
# Development timeseries analisys for JUnit4 (https://github.com/junit-team/junit5)
#
...
combined_e <- matrix(c(dev_e, bug_e, dvb_e, chr_e), nrow = 162)
#creating timeseries 
timeseries_e <- ts(combined_e, frequency = 1, names = c('enh', 'bug', 'e+b', 'churn'))
#plotting timeseries
plot(timeseries_e, main = "JUnit's DE x Churn")
...
ndata <- data[83:162, 4:9] # high correlation interval
